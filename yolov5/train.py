...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default=r"D:\yolo\yolov5\models\yolov5s.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/SODA-D.yaml", help="dataset.yaml path")
